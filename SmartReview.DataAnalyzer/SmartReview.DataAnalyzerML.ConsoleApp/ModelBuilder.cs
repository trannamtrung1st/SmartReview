...
namespace SmartReview_DataAnalyzerML.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"T:\FPT\STUDY\SUMMER2020\PRX\Project\SmartReview\yelp.tsv";
        private static string MODEL_FILEPATH = @"C:\Users\TNT\AppData\Local\Temp\MLVSTools\SmartReview.DataAnalyzerML\SmartReview.DataAnalyzerML.Model\MLModel.zip";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var trainer = mlContext.BinaryClassification.Trainers.AveragedPerceptron(labelColumnName: "stars", numberOfIterations: 10, featureColumnName: "Features");
